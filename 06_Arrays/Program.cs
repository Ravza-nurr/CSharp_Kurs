...
namespace _06_Arrays
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine(cities[4]);  //olmayan index yazılırsa hata verir

            //int[] numbers = new int[10]; // elemanlarının tamamını doldurmak zorunda değiliz
            //numbers[0] = 50;
            //numbers[1] = 40;
            //numbers[2] = 698;
            //numbers[3] = 24;
            ...
            //for (int i = 0; i < colors.Length; i++) // <= denseydi son kısımda hata verirdi çünkü dizide 7 indexli eleman yok.
            //{
            ...
            #region Dizi_Metodları

            //string[] customers = { "ali", "buse", "ayşegül", "merve", "çınar", "kaya" };
            //int index = Array.IndexOf(customers, "merve"); // "merve"nin index numarasını alır
